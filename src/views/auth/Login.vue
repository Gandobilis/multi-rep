...
<template>
  <form @submit.prevent="login">
    ...
    <button class="w-full rounded text-white bg-primary py-[6.5px] mb-[15px] hover:shadow-2xl">
      შესვლა
    </button>

    <h3 class="flex justify-center mb-[15px]">ან</h3>

    <router-link to="/auth/register" class="w-full text-center text-primary py-[6.5px] rounded-[5px] hover:bg-primary hover:text-white hover:shadow-2xl">
      რეგისტრაცია
    </router-link>
  </form>
</template>
