...
<template>
  <div class="relative">
    ...
    <div class="absolute z-10 border border-black rounded-md top-12 right-0" :class="show ? 'block' : 'hidden'">
      <p class="whitespace-nowrap text-sm font-bold p-3">შენახული განცხადები</p>
      <div class="flex flex-col border-t border-black p-3 gap-y-2">
        <router-link
            to="/"
            @click="show = !show"
