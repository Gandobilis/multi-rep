...
<template>
  <div class="relative w-full">
    <input
        ...
        class="max-lg:text-[10px] w-full border lg:border-2 border-black font-medium placeholder-black rounded-md lg:rounded-lg p-1.5 lg:p-3 hover:border-primary hover:cursor-pointer focus:outline-primary focus:cursor-auto"
